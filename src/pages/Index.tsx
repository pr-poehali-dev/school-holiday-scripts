...
const scenarios = [
  {
    ...
    program: [
      { time: '5 мин', activity: 'Приветствие ведущего с песней о школе' },
      { time: '10 мин', activity: 'Игра "Узнай друга" (описания сверстников)' },
      { time: '15 мин', activity: 'Конкурс рисунков "Моя мечта в школе"' },
      { time: '10 мин', activity: 'Эстафета с шариками' },
      { time: '5 мин', activity: 'Групповой хоровод и фото' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '5 мин', activity: 'Появление Деда Мороза с приветствием' },
      { time: '10 мин', activity: 'Загадки о зиме' },
      { time: '10 мин', activity: 'Танец "Снежинки"' },
      { time: '10 мин', activity: 'Конкурс "Снежные шары" (мячики)' },
      { time: '15 мин', activity: 'Хоровод вокруг елки с подарками, пожелания на будущее' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '5 мин', activity: 'Стихи о учителе' },
      { time: '10 мин', activity: 'Мини-сценка "День из жизни учителя"' },
      { time: '10 мин', activity: 'Конкурс открыток "Спасибо"' },
      { time: '10 мин', activity: 'Концерт номеров (песни, рисунки)' },
      { time: '5 мин', activity: 'Чай с угощениями' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '5 мин', activity: 'Видео-приветствия от детей' },
      { time: '10 мин', activity: 'Танец "Мамины ручки"' },
      { time: '15 мин', activity: 'Конкурс "Семейные истории" (стихи)' },
      { time: '10 мин', activity: 'Мастер-класс по букетикам' },
      { time: '5 мин', activity: 'Песни о семье' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '5 мин', activity: 'Гимн и стихи' },
      { time: '10 мин', activity: 'Викторина "Герои Родины"' },
      { time: '15 мин', activity: 'Эстафета "Военная подготовка"' },
      { time: '10 мин', activity: 'Творческие номера (песни)' },
      { time: '10 мин', activity: '"Салют" из конфетти, вручение медалей' }
    ],
                    ...
                    <AccordionContent>
                      <div className="space-y-3 mt-3">
                        {currentScenario.program.map((item, i) => (
                          <div key={i} className="flex gap-4 bg-accent/5 p-4 rounded-lg border-l-2 border-accent">
                            <Badge variant="outline" className="shrink-0">
                              {item.time}
                            </Badge>
                            <p className="flex-1">{item.activity}</p>
                          </div>
                        ))}
                      </div>
                    </AccordionContent>
