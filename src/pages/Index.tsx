...
const scenarios = [
  ...
  },
  {
    ...
    program: [
      { time: '5 мин', activity: 'Вступление: Весенние песни', description: 'Дети выходят на сцену в весенних костюмах (платья с цветами, банты). Исполняют песню "Весна-красна" хором. Ведущая в образе Весны приветствует всех женщин и девочек в зале, говорит теплые слова о весне и красоте.' },
      { time: '15 мин', activity: 'Мастер-класс "Весенний букет"', description: 'Каждый ребенок получает набор: цветная бумага, ножницы, клей, ленты. Учитель показывает на экране пошаговую инструкцию создания бумажного тюльпана или нарцисса. Дети вырезают лепестки, склеивают цветы, оформляют букетики лентами. Фоном звучат весенние мелодии. Готовые букеты дети позже подарят мамам и бабушкам.' },
      { time: '10 мин', activity: 'Танец "Весна пришла"', description: 'Группа из 8-10 девочек в белых и желтых платьях исполняет танец с лентами под мелодию "Весенний вальс". Движения легкие, плавные: взмахи лентами, кружения, волны руками, имитирующие ветер и цветение. Мальчики стоят сбоку и держат плакаты с весенними рисунками.' },
      { time: '5 мин', activity: 'Поздравления', description: 'Мальчики по очереди выходят и читают короткие поздравления в стихах для девочек и учительниц. Каждый вручает самодельную открытку или цветок. Звучат аплодисменты, девочки улыбаются и благодарят.' },
      { time: '5 мин', activity: 'Завершение: Чай', description: 'Все садятся за накрытые столы, пьют чай с печеньем и сладостями. Мальчики официально вручают девочкам подготовленные букеты. Фоном играет легкая фольклорная музыка. Царит атмосфера праздника и весеннего настроения.' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '10 мин', activity: 'Вступление: Мини-экскурсия', description: 'Директор или старший учитель проводит детей по школьным коридорам, показывает старые фотографии на стендах. Рассказывает, когда школа открылась, сколько выпусков было, какие известные люди здесь учились. Дети задают вопросы, рассматривают кубки и грамоты в витринах.' },
      { time: '15 мин', activity: 'Квест "История школы"', description: 'Класс делится на 4 команды по 6 человек. Каждая команда получает карту с заданиями: найти кабинет с определенным номером, ответить на вопрос о школе (год основания, имя первого директора), сфотографироваться у школьного символа. Команды бегают по этажам, собирают буквы для финального слова "МЫ ГОРДИМСЯ ШКОЛОЙ". Побеждает команда, которая быстрее соберет все буквы и вернется к старту.' },
      { time: '10 мин', activity: 'Флешмоб-танец', description: 'Все дети выстраиваются на школьном дворе или в актовом зале. Включается энергичная музыка "Школьный марш". Старшеклассники-аниматоры показывают простые движения: хлопки, прыжки, махи руками, повороты. Дети синхронно повторяют. Учителя снимают на камеры, родители аплодируют. Это веселый массовый танец, символизирующий единство школы.' },
      { time: '10 мин', activity: 'Выступления', description: 'От каждого класса выходит по 1-2 представителя и показывает номер: кто-то поет песню о школе, кто-то читает стих, кто-то показывает фокус или сценку. Всего 5-6 номеров по 1-2 минуты. Жюри из учителей оценивает выступления символическими призами (наклейки, значки). Атмосфера концертная, поддержка и аплодисменты после каждого номера.' },
      { time: '5 мин', activity: 'Завершение: Обещания "Буду хорошим учеником"', description: 'Все дети встают в большой круг. Ведущий произносит клятву: "Обещаю хорошо учиться, уважать учителей, беречь школьное имущество, дружить с одноклассниками". Дети хором повторяют: "Обещаем!". После этого запускают в небо (или вверх в зале) воздушные шары с прикрепленными пожеланиями школе. Звучат фанфары. Делается общее фото всех участников.' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '10 мин', activity: 'Вступление: Хоровод с песнями', description: 'Дети в народных костюмах (сарафаны, косоворотки, платки) выходят на школьный двор или площадку. Взявшись за руки, водят хоровод под русскую народную песню "Ой, то не вечер". Ведущий в роли Скомороха приветствует всех, объявляет начало Масленицы, призывает прощаться с зимой и встречать весну. Дети поют, хлопают в ладоши.' },
      { time: '15 мин', activity: 'Конкурс блинов', description: 'На столах заранее разложены блины (приготовленные взрослыми). Конкурс состоит из двух этапов: 1) скорость – кто быстрее съест 3 блина без начинки (безопасно, маленькие блины); 2) творчество – дети украшают блины вареньем, сметаной, делают смешные рожицы. Жюри из родителей выбирает самый красивый "блинный портрет". Победители получают бумажные медали "Лучший блиновед".' },
      { time: '20 мин', activity: 'Игры "Солнышко"', description: 'Проводится несколько народных игр подряд: 1) "Ручеек" – дети встают парами, образуют коридор, водящий проходит и выбирает пару (5 мин); 2) "Перетягивание каната" – две команды соревнуются в силе (5 мин); 3) "Бег в мешках" – прыжки в мешках до финиша (5 мин); 4) "Метание валенка" – кто дальше кинет валенок (5 мин). За победу в каждой игре команда получает солнышко-наклейку.' },
      { time: '10 мин', activity: 'Кульминация: Символическое "сжигание" зимы', description: 'В центре двора установлено соломенное чучело Зимы с нарисованным лицом. Дети встают вокруг, Скоморох произносит прощальные слова: "Прощай, Зима, приходи, Весна!". Вместо настоящего сжигания (для безопасности) чучело "разбирают" – каждый ребенок берет по соломинке и кладет в корзину, символически "унося" зиму. Звучат весенние песни, запускают желтые и зеленые ленты вверх.' },
      { time: '5 мин', activity: 'Завершение: Танцы', description: 'Все дети и взрослые становятся в большой круг, танцуют под веселые потешки: "Барыня", "Калинка". Движения простые: притопы, хлопки, кружения. Угощают всех блинами и горячим чаем из термосов. Праздник завершается общим фото с надписью "Масленица 2025".' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '5 мин', activity: 'Вступление: Видео о планете', description: 'На экране проектора показывают короткометражный видеоролик о красоте Земли: леса, океаны, животные, но также показывают проблемы – мусор, загрязнение, вырубку лесов. Дети смотрят внимательно, учитель комментирует: "Наша планета нуждается в защите". После видео задают вопрос: "Что мы можем сделать, чтобы помочь Земле?" Дети поднимают руки, высказывают идеи.' },
      { time: '10 мин', activity: 'Эко-викторина', description: 'Ведущий задает вопросы экологической тематики: "Сколько лет разлагается пластиковая бутылка?" (450 лет), "Какое дерево дает больше всего кислорода?" (дуб), "Что нужно делать с батарейками?" (сдавать на переработку). За правильные ответы дети получают зеленые листочки-наклейки. Викторина в игровой форме, с подсказками и картинками на слайдах.' },
      { time: '15 мин', activity: 'Посадка семян', description: 'Каждый ребенок получает маленький пластиковый горшочек (или стаканчик из переработанного материала), землю, лопаточку и семена (петрушка, укроп или цветы – бархатцы). Учитель показывает пошагово: насыпать землю, сделать ямку пальцем, положить семечко, присыпать, полить из пипетки. Дети подписывают горшочки своими именами маркером. Эти растения они заберут домой и будут ухаживать, наблюдая за ростом.' },
      { time: '10 мин', activity: 'Создание плакатов', description: 'Класс делится на группы по 5 человек. Каждая группа получает ватман, маркеры, картинки из журналов (вырезанные заранее). Задание: создать плакат на тему "Береги природу!" или "Планета в опасности!". Дети рисуют, клеят картинки, пишут лозунги: "Не мусори!", "Сажай деревья!", "Экономь воду!". Через 10 минут каждая группа показывает свой плакат классу и объясняет идею. Плакаты вешают в коридоре школы.' },
      { time: '5 мин', activity: 'Завершение: Обсуждение', description: 'Все садятся в круг на ковре. Учитель спрашивает: "Что нового вы узнали сегодня? Что будете делать, чтобы помочь Земле?". Дети делятся мыслями: буду выключать воду, сортировать мусор, не рвать цветы. Учитель хвалит, дает финальное напутствие: "Вы – защитники Земли!". Все вместе произносят: "Мы любим нашу планету!" и хлопают в ладоши. Звучит песня "Земля в иллюминаторе".' }
    ],
  ...
  },
  {
    ...
    program: [
      { time: '10 мин', activity: 'Вступление: Поздравление учителя и стихи учеников о Азбуке', description: 'Класс украшен плакатом "Спасибо, Азбука!", на доске висят буквы алфавита. Учитель выходит, поздравляет первоклассников с важным событием – они прочитали первую книгу! Дети по очереди (5-6 человек) читают короткие стихи: "Азбука, ты – первый друг", "Буквы все мы изучили". После каждого стиха – аплодисменты. Родители сидят в зале, снимают на телефоны.' },
      { time: '5 мин', activity: 'Игра "Это я!"', description: 'Учитель задает вопросы, дети отвечают хором "Это я, это я, это все мои друзья!" если согласны, или молчат, если нет. Вопросы: "Кто ватагою веселой каждый день шагает в школу?" (да), "Кто из вас приходит в класс с опозданием на час?" (молчат), "Кто из вас хранит в порядке книжки, ручки и тетрадки?" (да). Игра веселая, дети смеются, путаются, но большинство отвечает правильно.' },
      { time: '15 мин', activity: 'Сцена с Золушкой и мачехой', description: 'Инсценировка: девочка в роли Золушки (фартук, платок) подметает пол. Входит "мачеха" (другая девочка в смешном костюме с короной). Мачеха запрещает Золушке идти на праздник Азбуки, дает задания: помыть посуду (тарелку и полотенце на сцене), перебрать крупу (имитация). Золушка грустит. Но вдруг появляется Фея (учитель или старшеклассница с волшебной палочкой) и говорит: "Ты прочитала Азбуку – ты заслужила праздник!" Превращает Золушку (меняет фартук на красивое платье), и Золушка идет на праздник. Дети аплодируют. Сценка учит, что знания – это волшебство.' },
      { time: '5 мин', activity: 'Сбор слов из слогов', description: 'Учитель раздает 4 конверта разным детям. В каждом конверте – карточки со слогами. Задание: собрать из слогов слова. Примеры: РО-ЩА, СВЕ-ЧА, РО-ТА, ТУ-ЧА, ПИ-ЩА, ЩУ-КА. Дети в парах или тройках раскладывают карточки на партах, составляют слова, поднимают руки. Учитель проверяет, хвалит. Побеждает команда, собравшая больше слов за 5 минут. Это проверка навыка чтения и слогового анализа.' },
      { time: '5 мин', activity: 'Игра "Живые буквы"', description: 'Учитель называет букву, и дети должны встать и своим телом изобразить эту букву. Например, буква "Т" – руки в стороны, ноги вместе; "К" – одна рука вверх по диагонали, одна нога согнута; "Г" – рука вперед, тело прямое; "Ж" – руки и ноги в стороны. Учитель показывает пример, дети повторяют. Это весело и развивает моторику, пространственное мышление. Учитель фотографирует "букв" для альбома класса.' },
      { time: '5 мин', activity: 'Музыкальная игра "Все – друзья!"', description: 'Включается веселая песня "Все – друзья!" (или "Вперед четыре шага"). Учитель показывает движения: шаг вперед, шаг назад, хлопки, повороты. Дети встают в круг и танцуют, повторяя движения. Игра сближает детей, создает атмосферу дружбы и веселья. Родители подпевают, некоторые встают и танцуют вместе с детьми. Это энергичный и радостный момент праздника.' },
      { time: '5 мин', activity: 'Завершение: Финальные стихи и хоровод "Благодарю, Азбука!"', description: 'Все дети встают в круг, взявшись за руки. Хором читают финальное стихотворение: "Азбука, спасибо, ты нас научила читать. Теперь мы будем много книг читать!" После этого водят медленный хоровод под школьную песню. В центре круга лежит большая книга "Азбука" (бутафория). Каждый ребенок по очереди подходит, гладит книгу, говорит "Спасибо". Учитель вручает каждому диплом "Азбуку прочел!" или медаль. Родители аплодируют стоя. Делается общее фото класса с учителем и Азбукой. Праздник завершен!' }
    ],
